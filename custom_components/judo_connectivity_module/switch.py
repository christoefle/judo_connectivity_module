"""Switch platform for judo_connectivity_module."""
...
class JudoConnectivityModuleSwitch(JudoConnectivityModuleEntity, SwitchEntity):
    """judo_connectivity_module switch class."""
